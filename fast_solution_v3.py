...
# A, paths
# train = '/home/liux/Desktop/blarainck306@gmail.com/LAI_OFFER/ALL_PROJECTS/9_AvazuCTR_link/Data/train.csv'               # path to training file
train = 'train.csv'
...
class ftrl_proximal(object):
    ...
    def _indices(self, x):
        ...
        this function generate hashing feature index of the features in x one by one, this also applies to the interaction term if applicable
    ...
    def predict(self, x):
        ...
        wTx = 0.
        # liu: iterate through all non-zero feature values:
